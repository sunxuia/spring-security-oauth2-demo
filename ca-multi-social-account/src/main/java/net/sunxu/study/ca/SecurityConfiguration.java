...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    @Autowired
    private WeiboPrincipalExtractor weiboPrincipalExtractor;
    ...
    private Filter getGithubFilter() {
        ...
        var tokenService = new UserInfoTokenServices(github.getResource().getUserInfoUri(),
                github.getClient().getClientId());
        tokenService.setRestTemplate(oAuth2Tempalate);
        tokenService.setPrincipalExtractor(githubPrincipalExtractor);
    ...
    private Filter getWeiboFilter() {
        ...
        tokenService.setPrincipalExtractor(weiboPrincipalExtractor);
